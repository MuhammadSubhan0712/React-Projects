...
const Home = () => {
  return (
    <div className="home">
      <Navbar />
      <div className="hero">
        <img src={hero_banner} alt="hero-ban" className="banner-img" />
        ...
        <div className="hero-caption">
          ...
          <div className="hero-btns">
            ...
            <button className="btn dark-btn"><img src={info_icon} alt="play icon" />More Info</button>
          </div>
          <TitleCards />
        </div>
      </div>
